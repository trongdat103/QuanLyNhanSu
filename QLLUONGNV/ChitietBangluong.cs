...
namespace QLLUONGNV
{
    public partial class ChitietBangluong : Form
    {
        ...
        private void dgvLuongsg_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            // Kiểm tra nếu đang định dạng cột "Thuclanh"
            if (dgvLuongsg.Columns[e.ColumnIndex].Name == "Thuclanh" && e.RowIndex >= 0)
            {
            ...
            if (dgvLuongsg.Columns[e.ColumnIndex].Name == "HesoCV" && e.RowIndex >= 0)
            {
                // Kiểm tra giá trị của ô
                if (e.Value != null)
                {
            ...
            if (dgvLuongsg.Columns[e.ColumnIndex].Name == "Luongcoban" && e.RowIndex >= 0)
            {
                // Kiểm tra giá trị của ô
                if (e.Value != null)
                {
            ...
            if (dgvLuongsg.Columns[e.ColumnIndex].Name == "TongThuong" && e.RowIndex >= 0)
            {
                // Kiểm tra giá trị của ô
                if (e.Value != null)
                {
            ...
            if (dgvLuongsg.Columns[e.ColumnIndex].Name == "TongTru" && e.RowIndex >= 0)
            {
                // Kiểm tra giá trị của ô
                if (e.Value != null)
                {
            ...
            if (dgvLuongsg.Columns[e.ColumnIndex].Name == "LuongThucTe" && e.RowIndex >= 0)
            {
                // Kiểm tra giá trị của ô
                if (e.Value != null)
                {
            ...
            if (dgvLuongsg.Columns[e.ColumnIndex].Name == "Luongngay" && e.RowIndex >= 0)
            {
                // Kiểm tra giá trị của ô
                if (e.Value != null)
                {
                    double Luongngay;
                    // Chuyển giá trị của ô thành kiểu double
                    if (double.TryParse(e.Value.ToString(), out Luongngay))
                    {
                        // Làm tròn đến 0 chữ số thập phân và định dạng lại giá trị của ô theo đơn vị tiền tệ Việt Nam
                        e.Value = Luongngay.ToString("#,##0") + " VNĐ";
                        e.FormattingApplied = true;
                    }
                }
            }
